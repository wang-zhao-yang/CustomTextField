...
- (CGSize)labelText:(NSString *)text fondSize:(float)size width:(CGFloat)width {
    ...
    CGSize textSize = [text boundingRectWithSize:CGSizeMake(width, 0) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:send context:nil].size;
    return textSize;
}
